...
public class MapBenchmarkV2 {
    ...
    private Map<TestModel, Integer> concurrentHashMap;
    private CopyOnWriteArraySet<TestModel> copyOnWriteArraySet;
    ...
    public void setup() {
        ...
        for (int ratio : readToWriteRatios) {
            ...
            copyOnWriteArraySet = new CopyOnWriteArraySet<>(concurrentHashMap.keySet());
        }
    }

    @Benchmark
    public void benchmarkConcurrentHashMap() throws ExecutionException, InterruptedException {
        testMapPerformance(concurrentHashMap, ops, threads);
    }

    @Benchmark
    public void benchmarkPMap() throws ExecutionException, InterruptedException {
        testMapPerformance(pMap, ops, threads);
    }

    @Benchmark
    public void benchmarkCopyOnWriteArraySet() throws ExecutionException, InterruptedException {
